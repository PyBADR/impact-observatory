...
export default function ArchitecturePage() {
  ...
  const archBlocks = [
    { step: '01', icon: FileText, title: { en: 'Scenario Input', ar: 'إدخال السيناريو' }, desc: { en: 'Users select from 17 strategic GCC risk scenarios across 6 groups or configure custom shock vectors. Each scenario defines initial impact nodes and severity levels.', ar: 'يختار المستخدمون من 17 سيناريو مخاطر خليجي استراتيجي عبر 6 مجموعات أو يضبطون متجهات صدمة مخصصة. كل سيناريو يحدد عقد التأثير الأولية ومستويات الحدة.' }, features: [{ en: 'Bilingual AR/EN', ar: 'ثنائي اللغة' }, { en: '17 strategic scenarios', ar: '17 سيناريو استراتيجي' }, { en: 'Severity slider', ar: 'شريط الحدة' }, { en: 'Shock vector config', ar: 'ضبط متجه الصدمة' }] },
